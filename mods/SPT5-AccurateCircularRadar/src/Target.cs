...
namespace Radar
{
    ...
    /// </summary>
    /// <remarks>
    /// 4.1 -> 5.0 适配（IL2CPP）：interop 的 <c>Transform.Find</c> 按声明返回类型包装代理对象，
    /// 因此 <c>is RectTransform</c> 模式匹配恒为 false；改用 <c>TryCast&lt;RectTransform&gt;()</c>。
    /// </remarks>
    public abstract class Target
    {
        ...
        public static BifacialTransform PlayerTransform { get; private set; }
        ...
        protected Target()
        {
            ...
            RectTransform blipTransform = blip.transform.Find("Blip/RadarEnemyBlip").TryCast<RectTransform>();
