...
[BepInPlugin("com.dirtbikercj.SkillsExtended", "Skills Extended", "1.6.0")]
...
public class SkillsPlugin : BaseUnityPlugin
{
    ...
    private void Start()
    {
        Keys = SkillsExtended.Helpers.Utils.Get<KeysResponse>("/skillsExtended/GetKeys");
        SkillData = SkillsExtended.Helpers.Utils.Get<SkillDataResponse>("/skillsExtended/GetSkillsConfig");
