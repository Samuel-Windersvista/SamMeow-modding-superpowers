...
public class LockPickingGame : MonoBehaviour
{
    ...
    private void SetTimeLimit(int doorLevel)
    {
        ...
        _wiggleTimeLimit = SkillsExtended.Helpers.Utils.RandomizePercentage(originalLimit, 0.10f);
    }
}
