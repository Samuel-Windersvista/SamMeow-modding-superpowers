...
internal static class LockPickingHelpers
{
    ...
    public static void DisplayInspectInformation(WorldInteractiveObject interactiveObject, GamePlayerOwner owner)
    {
        ...
        EFT.Communications.NotificationManager.DisplayMessageNotification($"Key for door is {SkillsPlugin.Keys.KeyLocale[interactiveObject.KeyId]}");
        EFT.Communications.NotificationManager.DisplayMessageNotification($"Lock level {doorLevel}");
    }
