...
public static class WorldInteractionUtils
{
    ...
    public static void AddLockpickingInteraction(this WorldInteractiveObject interactiveObject, AvailableInteractionState actionReturn, GamePlayerOwner owner)
    {
    ...
    public static void AddKeyCardInteraction(this KeycardDoor door, AvailableInteractionState actionReturn, GamePlayerOwner owner)
    {
    ...
    public static void AddInspectInteraction(this WorldInteractiveObject interactiveObject, AvailableInteractionState actionReturn, GamePlayerOwner owner)
    {
