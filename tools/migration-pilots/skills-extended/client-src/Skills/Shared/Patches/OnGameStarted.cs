...
internal class OnGameStartedPatch : ModulePatch
{
    ...
    private static void ApplyMedicalXp(EFT.HealthSystem.IHealthEffect effect)
    {
    ...
    private static void ApplyNatoRifleXp(EFT.Mastering skillClass)
    {
    ...
    private static void ApplyEasternRifleXp(EFT.Mastering skillClass)
    {
