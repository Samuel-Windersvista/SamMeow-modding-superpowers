...
internal class SkillClassCtorPatch : ModulePatch
{
    protected override MethodBase GetTargetMethod() =>
        typeof(EFT.Skill).GetConstructor(
            BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic, 
            null, 
            [typeof(SkillManager), typeof(ESkillId), typeof(ESkillClass), typeof(SkillManager.SkillAction[]), typeof(SkillManager.FloatBuff[])], 
            null);
    ...
    public static void Prefix(
        ...
        ESkillId id, 
        ref SkillManager.FloatBuff[] buffs, 
