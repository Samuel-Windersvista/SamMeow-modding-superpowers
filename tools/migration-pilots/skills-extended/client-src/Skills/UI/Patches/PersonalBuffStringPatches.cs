...
internal class PersonalBuffFullStringPatch : ModulePatch
{
    ...
    {
        return AccessTools.Method(typeof(EFT.HealthSystem.EffectsSettings.StimulatorSettings.StimulatorBuffSettings), nameof(EFT.HealthSystem.EffectsSettings.StimulatorSettings.StimulatorBuffSettings.GetStringValue));
    }

    [PatchPostfix]
    public static void PostFix(
        EFT.HealthSystem.EffectsSettings.StimulatorSettings.StimulatorBuffSettings __instance,
        ...
        ref string __result)
    {
        ...
        if (!flag)
        {
            ...
            stringBuilder.Append(__instance.GetStringValue());
        }
