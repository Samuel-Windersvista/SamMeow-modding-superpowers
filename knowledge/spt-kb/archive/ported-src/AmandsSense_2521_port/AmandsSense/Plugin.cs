...
namespace AmandsSense
{
    ...
    public class AmandsKillPatch : ModulePatch
    {
        ...
        [PatchPostfix]
        private static void PatchPostFix(ref Player __instance, IPlayer aggressor, EFT.Ballistics.DamageInfo damageInfo, EBodyPart bodyPart, EDamageType lethalDamageType)
        {
            AmandsSenseClass.DeadPlayers.Add(new SenseDeadPlayerStruct(__instance, aggressor as Player));
        }
    }
