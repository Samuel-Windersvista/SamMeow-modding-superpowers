...
namespace AmandsSense
{
    public class AmandsSenseHelper
    {
        ...
        public static void Init()
        {
            ...
            Type ssaaType = PatchConstants.EftTypes.FirstOrDefault((Type x) => x.GetMethod("UsesFSR2Upscaler", BindingFlags.Public | BindingFlags.Instance) != null);
            UsesFSR2UpscalerMethod = ssaaType != null ? ssaaType.GetMethod("UsesFSR2Upscaler", BindingFlags.Public | BindingFlags.Instance) : null;
