...
namespace TraderModding
{
    internal class TraderModdingUtils
    {
        ...
        {
            TextMeshProUGUI caption = modItemView.Caption;
           ...
           Image modTypeIcon = itemViewStats._modTypeIcon;
            ...
            if (caption != null && modTypeIcon != null)
            {
                ...
                if (Globals.traderModInfo.TryGetValue(item.TemplateId, out var modInfo))
                {
                    ...
                    Image colorPanel = modItemView.ColorPanel;
                    ...
                    if (modItemView._notAvailable != null)
                        modItemView._notAvailable.SetActive(false);
                    if (modItemView._availableFromMerchants != null)
                        modItemView._availableFromMerchants.SetActive(false);
                }
            }
        }
