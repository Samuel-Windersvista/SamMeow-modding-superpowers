...
namespace TraderModding
{
    public class EditBuildScreenPatch : ModulePatch
    {
        ...
        public static async void Postfix(EditBuildScreen __instance)
        {
            ...
            Globals.checkbox_availableOnly_toggle = __instance._onlyAvailableToggle;
            ...
            ButtonWithHint assembleButton = __instance._assembleButton;
            ...
            Button detachButton = detachButtonWithHint._button;
            ...
            TextMeshProUGUI detachLabel = detachButtonWithHint._label;
            ...
            Button quickBuyButton = quickbuyButtonWithHint._button;
            ...
            if (iconT != null) {
                ...
                icon.sprite = EFTHardSettings.Instance.StaticIcons.DialogLineSprites[DialogLineTemplate.EDialogLineIconType.ShoppingCart];
                icon.color = new Color(0.5f, 1f, 0.3f, 1.0f);
            }

            TextMeshProUGUI label = quickbuyButtonWithHint._label;
            ...
            Globals.fakestash.Grids[0] = new CornucopiaGrid(Guid.NewGuid().ToString(), 30, 1, true, Array.Empty<ItemFilter>(),  Globals.fakestash);
            Globals.fakestashTraderController = new ItemController( Globals.fakestash, "TraderModdingStash", Guid.NewGuid().ToString(), false);
            ...
            if (FieldInfos.EditBuildScreen_profile == null) { ConsoleScreen.LogError("FieldInfo for profile == null"); return; }
            Globals.profile = (Profile)FieldInfos.EditBuildScreen_profile.GetValue(__instance);
    ...
    {             
        ...
        [PatchPostfix]
        public static void Postfix(EditBuildScreen __instance, EditBuildScreen.EditBuildScreenController controller)
        {
            ...
            {
                TextMeshProUGUI weaponName = __instance._weaponName;
    ...
    public class EditBuildScreenAssembledWeaponPatch : ModulePatch
    {
        protected override MethodBase GetTargetMethod()
        {
            return AccessTools.FirstMethod(typeof(WeaponAssembler),
                x => x.Name == nameof(WeaponAssembler.Assemble));
        }
