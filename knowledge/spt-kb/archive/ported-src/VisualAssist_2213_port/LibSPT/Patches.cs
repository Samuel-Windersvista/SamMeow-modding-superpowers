...
public class GrenadeThrowPrefixPatch : ModulePatch
{
    ...
    {
        return typeof(Player.BaseGrenadeHandsController).GetMethod(nameof(Player.BaseGrenadeHandsController.Throw));
    }

    [PatchPrefix]
    public static bool Prefix(
        Player.BaseGrenadeHandsController __instance, Player ____player, Transform ____dropTransform, bool low, float timeSinceSafetyLevelRemoved
    )
    {
        ...
        __instance.ThrowGrenade(
            timeSinceSafetyLevelRemoved, grenadeArc.GrenadeThrow.ThrowPosition, ____dropTransform.rotation, grenadeArc.GrenadeThrow.ThrowForce, low
        );
