...
namespace TaskAutomation.Helpers
{
    internal static class LogHelper
    {
        ...
        {
            LogInfo(info);
            NotificationManager.DisplayMessageNotification(info, EFT.Communications.ENotificationDurationType.Default, EFT.Communications.ENotificationIconType.Default, null);
        }
