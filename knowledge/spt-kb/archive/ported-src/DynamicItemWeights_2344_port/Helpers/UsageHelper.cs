...
namespace Tosox.DynamicItemWeights.Helpers
{
    public class UsageHelper
    {
        ...
        public bool TryGetUsageFraction(Item item, out float fraction)
        {
            ...
            if (item.TryGetItemComponent<ResourceComponent>(out var resource) && item is Fuel)
            {
            ...
            {
                fraction = Mathf.Clamp(repairKit.Resource / repairKit._template.MaxRepairResource, 0.0f, 1.0f);
                return true;
            }
