...
namespace LockableDoors.Components
{
    internal class DoorLock : MonoBehaviour
    {
        ...
        public void AddLockInteractionsToActionList(List<InteractionAction> vanillaActionList)
        {
        ...
        public static void AddUninitializedLockInteractionsToActionList(List<InteractionAction> vanillaActionList, Door door)
        {
        ...
        public class LockInteraction(DoorLock doorLock) : CustomInteraction
        {
            ...
            public override void OnInteract()
            {
                HandleLockFalloff();
                doorLock.Lock();
                NotificationManager.DisplayMessageNotification($"Locked! {LDSession.Instance.LockedDoorsCount}/{_doorLimitText} doors locked", ENotificationDurationType.Default, ENotificationIconType.Default, null);
            }
        }
        ...
        public class UnlockInteraction(DoorLock doorLock) : CustomInteraction
        {
            ...
            {
                doorLock.Unlock();
                NotificationManager.DisplayMessageNotification($"Unlocked! {LDSession.Instance.LockedDoorsCount}/{_doorLimitText} doors locked", ENotificationDurationType.Default, ENotificationIconType.Default, null);
