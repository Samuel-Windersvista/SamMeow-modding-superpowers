...
namespace hideoutcat
{
    ...
    public static class CatDependencyProviders
    {
        ...
        /// <summary>
        /// 4.1: replaced Singleton&lt;HideoutClass&gt;.Instance. Set by hideoutcat.bepinex.PatchHideoutInit
        /// from HideoutController.InitHideoutAreas(HideoutRepresentation); grants access to AreaDatas.
        /// </summary>
        public static HideoutRepresentation Hideout { get; set; }
