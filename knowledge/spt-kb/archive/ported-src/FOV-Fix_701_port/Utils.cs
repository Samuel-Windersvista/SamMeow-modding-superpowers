  ...
  public static class Utils
    {
        ...
        public static Player GetYourPlayer()
        {
            ...
            return gameWorld.AllPlayersEverExisted.FirstOrDefault(p => p.IsYourPlayer);
        }
        ...
        public static bool CheckIsReady()
        {
            ...
            Player player = gameWorld?.AllPlayersEverExisted.FirstOrDefault(p => p.IsYourPlayer);
            if (player != null)
            {
            ...
            if (gameWorld == null || gameWorld.AllPlayersEverExisted == null || gameWorld.AllPlayersEverExisted.FirstOrDefault(p => p.IsYourPlayer) == null || sessionResultPanel != null)
            {
        ...
        // SPT 4.1: TemplateIdToObjectMappingsClass was removed and this helper has no callers, so it was dropped in the port.
