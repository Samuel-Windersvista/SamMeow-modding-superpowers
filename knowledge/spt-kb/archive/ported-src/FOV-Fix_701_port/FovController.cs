...
namespace FOVFix
{
    ...
    public class FovController
    {
        ...
        public void ChangeMainCamFOV()
        {
            ...
            float baseFOV = _player.ProceduralWeaponAnimation.FieldOfView;
        ...
        public void ControllerUpdate()
        {
            ...
            if (_player == null) _player = Singleton<GameWorld>.Instance.AllPlayersEverExisted.FirstOrDefault(p => p.IsYourPlayer);
            if (_player != null)
            {
