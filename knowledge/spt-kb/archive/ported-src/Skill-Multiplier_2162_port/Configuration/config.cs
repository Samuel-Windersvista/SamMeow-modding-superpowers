...
namespace SkillMultiplier.Configuration
{
    public class Config
    {
        ...
        {
            NotificationManager.DisplayMessageNotification("Game restart required to change limits.", ENotificationDurationType.Long, ENotificationIconType.Default, null);
        }
