...
namespace dvize.DadGamerMode.Features
{
    internal class MagReloadSpeed : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            {
                Singleton<GlobalConfiguration>.Instance.BaseLoadTime = dadGamerPlugin.ReloadSpeed.Value;
                Singleton<GlobalConfiguration>.Instance.BaseUnloadTime = dadGamerPlugin.UnloadSpeed.Value;
            } 
        }
        ...
        private void OnToggleReloadUnloadSpeedChanged(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                Singleton<GlobalConfiguration>.Instance.BaseLoadTime = 0.85f;
                Singleton<GlobalConfiguration>.Instance.BaseUnloadTime = 0.3f;
