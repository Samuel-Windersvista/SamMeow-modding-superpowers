...
internal class SetHostilityPatch
{
    ...
    {
        var humanPlayers = Singleton<GameWorld>.Instance.AllPlayersEverExisted
        ...
        var activatedBots = Singleton<IBotGame>.Instance.BotsController.BotSpawner._bots.BotOwners
        ...
        foreach (var sameGroupMember in newBot.BotsGroup._members) {
            newBot.BotsGroup.RemoveEnemy(sameGroupMember, EBotEnemyCause.initial);
        }
    }
