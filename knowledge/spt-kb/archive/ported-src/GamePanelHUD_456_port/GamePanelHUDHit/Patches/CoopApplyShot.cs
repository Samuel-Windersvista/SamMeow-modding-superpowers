...
namespace GamePanelHUDHit
{
    ...
    {
        private static void CoopApplyShot(Player __instance, EFT.Ballistics.DamageInfo damageInfo, EBodyPart bodyPartType,
            EBodyPartColliderType colliderType)
        {
            ...
            var store = _HealthControllerHelper.ObservedCoopStore(
                (EFT.HealthSystem.NetworkHealthController)__instance.HealthController);
