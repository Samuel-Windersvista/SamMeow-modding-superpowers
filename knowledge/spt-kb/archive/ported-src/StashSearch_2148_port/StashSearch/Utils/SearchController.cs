...
namespace StashSearch.Utils
{
    internal class SearchController
    {
        ...
        public static Grid SearchedGrid = null;
        ...
        public HashSet<Item> Search(string searchString, Grid gridToSearch, string parentGridID)
        {
        ...
        public void RestoreHiddenItems(Grid gridToRestore)
        {
            try
            {
        ...
        /// <exception cref="Exception"></exception>
        private void SearchGrid(string searchString, Grid gridToSearch)
        {
            try
            { 
        ...
        private bool IsSearchedItem(Item item, string searchString)
        {
            ...
            if (!match)
            {
                var itemParent = (item.Template.ParentId?.ToString() ?? string.Empty).ToLower();
