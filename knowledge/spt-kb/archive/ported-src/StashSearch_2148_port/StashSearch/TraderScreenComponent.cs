...
namespace StashSearch
{
    internal class TraderScreenComponent : MonoBehaviour
    {
        ...
        private StashSearch.Utils.SearchController _searchControllerPlayer;
        private StashSearch.Utils.SearchController _searchControllerTrader;
        ...
        private void Start()
        {
            ...
            _searchControllerPlayer = new StashSearch.Utils.SearchController();
            _searchControllerTrader = new StashSearch.Utils.SearchController();
