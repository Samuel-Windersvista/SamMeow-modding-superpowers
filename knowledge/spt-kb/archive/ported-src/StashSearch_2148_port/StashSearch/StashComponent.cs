...
namespace StashSearch
{
    internal class StashComponent : MonoBehaviour
    {
        ...
        private StashSearch.Utils.SearchController _searchController;
        ...
        // Players main stash
        private static Stash _playerStash => ClientAppUtils.GetMainApp().GetClientBackEndSession().Profile.Inventory.Stash;
        ...
        // Get the session
        public static IEftSession _session => ClientAppUtils.GetMainApp().GetClientBackEndSession();
        ...
        private void Start()
        {
            ...
            _searchController = new StashSearch.Utils.SearchController();
        }
        ...
        private void RefreshGridView(GridView gridView, HashSet<Item>? searchResult = null)
        {
            if (searchResult != null)
            {
                ...
                var gridItemDict = (Dictionary<string, ItemView>)AccessTools.Field(typeof(GridView), "ItemViews").GetValue(gridView);
