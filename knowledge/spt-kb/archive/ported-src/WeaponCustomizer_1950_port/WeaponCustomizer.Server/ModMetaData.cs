...
{
    public string ModGuid { get; init; } = "com.tyfon.weaponcustomizer";
    public string Name { get; init; } = "Weapon Customizer";
    ...
    public string Url { get; init; } = "https://github.com/tyfon7/weaponcustomizer";
