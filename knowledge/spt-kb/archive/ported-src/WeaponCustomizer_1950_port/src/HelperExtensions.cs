...
{
    // 4.1 removed SPT's Task.HandleExceptions extension; provide our own equivalent
    public static async void HandleExceptions(this Task task)
    {
        ...
        {
            Plugin.Instance.Logger.LogError("Task exception: " + ex.ToString());
        }
    }
    ...
    private static string GetFullSlotId(Slot slot)
    {
        ...
        sb.Append(" ");
        sb.Append(slot.ParentItem.StringTemplateId);
