...
public static class Customizations
{
                ...
                if (SaveList.Count > 0)
                {
                    try
                    {
                        ...
                        if (response != "Success")
                        {
                            ...
                            NotificationManager.DisplayWarningNotification("Failed to save weapon customization - check the server", ENotificationDurationType.Default);
                            return;
                        }
    ...
    public static async Task Load()
    {
        ...
        catch (Exception ex)
        {
            ...
            NotificationManager.DisplayWarningNotification("Failed to load Weapon Customizations - check the server", ENotificationDurationType.Default);
        }
    }
