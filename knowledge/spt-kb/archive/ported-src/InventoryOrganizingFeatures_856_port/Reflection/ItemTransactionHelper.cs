...
namespace Seion.Iof.Reflection
{
    ...
    internal static class ItemTransactionHelper
    {
        ...
        public static object Move(Item item, ItemAddress to, ItemController itemController, bool simulate = false)
        {
        ...
        // Usually simulate = true
        public static object TransferOrMerge(Item item, Item targetItem, ItemController itemController, bool simulate)
        {
