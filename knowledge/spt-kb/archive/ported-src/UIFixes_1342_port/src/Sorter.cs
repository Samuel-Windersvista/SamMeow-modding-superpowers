...
public static class Sorter
{
    ...
    public static bool FindStackForMerge(IEnumerable<EFT.InventoryLogic.IContainer> containers, Item itemToMerge, out StackableItem mergeableItem, int minimumStackSpace = 0)
    {
