...
public static class R
{
    ...
    public class ItemSpecificationPanel(object value) : UIElement(value)
    {
        ...
        public static void InitTypes()
        {
            ...
            // 4.1.2: the static refresh helper (3.x smethod_1) was removed; RecreateAttributeBars is now instance-based.
            // The Refresh() wrapper below is unused; kept for source parity only.
            RefreshMethod = AccessTools.Method(Type, nameof(EFT.UI.ItemSpecificationPanel.RecreateAttributeBars));
        }
    ...
    public class SwapOperation(object value) : Wrapper(value)
    {
        ...
        public static void InitTypes()
        {
            Type = AccessTools.Method(typeof(InteractionsHandlerClass), nameof(InteractionsHandlerClass.Swap)).ReturnType; // OperationResult<GClass3426>
