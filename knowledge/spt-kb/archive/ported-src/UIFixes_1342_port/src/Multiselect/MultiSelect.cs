...
public class MultiSelect
{
    ...
    private static bool InteractionAvailable(DragItemContext itemContext, EItemInfoButton interaction, ItemUiContext itemUiContext)
    {
        ...
        ItemContext innerContext = itemContext;
    ...
    {
        ApplyAll(itemUiContext, EItemInfoButton.Install, context => itemUiContext.InstallMod(context, new[] { itemUiContext.CurrentItemContext?.Item as CompoundItem }), allOrNothing);
    }
