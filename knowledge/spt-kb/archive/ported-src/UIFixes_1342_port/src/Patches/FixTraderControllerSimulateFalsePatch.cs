...
public static class FixTraderControllerPatches
{
    ...
    public class BlockPartialTransfersPatch : ModulePatch
    {
        ...
        [PatchPrefix]
        public static bool Prefix(Item item, Item targetItem, TraderControllerClass itemController, bool simulate, ref OperationResult<ITargetItemResult> __result)
        {
            ...
            OperationResult<MergeOperation> operation = InteractionsHandlerClass.Merge(item, targetItem, itemController, simulate);
            if (operation.Succeeded)
            {
