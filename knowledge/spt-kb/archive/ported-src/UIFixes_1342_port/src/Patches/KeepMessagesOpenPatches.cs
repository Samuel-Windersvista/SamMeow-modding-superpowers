...
public static class KeepMessagesOpenPatches
{
    ...
    public class SniffChatPanelClosePatch : ModulePatch
    {
        ...
        {
            return AccessTools.Method(typeof(ChatScreen), nameof(ChatScreen.Close));
        }
    ...
    public class ReopenMessagesPatch : ModulePatch
    {
        protected override MethodBase GetTargetMethod()
        {
            return AccessTools.Method(typeof(MainMenuControllerClass), nameof(MainMenuControllerClass.ScreenChangeHandler));
        }
