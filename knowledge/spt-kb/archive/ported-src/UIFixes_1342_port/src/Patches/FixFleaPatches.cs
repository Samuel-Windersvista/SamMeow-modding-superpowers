...
public static class FixFleaPatches
{
    ...
    public class SearchPatch : ModulePatch
    {
        protected override MethodBase GetTargetMethod()
        {
            return AccessTools.Method(typeof(RagfairCategoriesPanel), nameof(RagfairCategoriesPanel.SetInputFieldText));
        }
        ...
        public static bool Prefix(RagfairCategoriesPanel __instance, string arg)
        {
            ...
            if (arg.StartsWith("#") || __instance.Ragfair == null || __instance.Ragfair.FilterRule.ViewListType != EViewListType.AllOffers)
            {
                return true;
            }
        ...
        private static void DoSearch(RagfairCategoriesPanel panel)
        {
            ...
            panel.Ragfair.HandleDefaultFilter(EViewListType.AllOffers);
            FilterRule filterRule = panel.Ragfair.FilterRule;
