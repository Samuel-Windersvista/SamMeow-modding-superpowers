...
public static class WeaponModdingPatches
{
    ...
    public class MoveBeforeResizePatch : ModulePatch
    {
        ...
        [PatchPostfix]
        public static void Postfix(Item item, ItemAddress to, TraderControllerClass itemController, bool simulate, ref OperationResult<MoveOperation> __result)
        {
    ...
    public class MoveBeforeUnfoldPatch : ModulePatch
    {
        ...
        [PatchPostfix]
        public static void Postfix(FoldableComponent foldable, bool folded, bool simulate, ref OperationResult<FoldOperation> __result)
        {
            if (__result.Succeeded || InPatch || __result.Error is not MoveResizeError)
            {
                return;
    ...
    public static void TryMoving<T>(Item targetItem, TraderControllerClass itemController, bool simulate, ref OperationResult<T> __result, Func<OperationResult<T>> func) where T : IRaiseEvents
    {
    ...
    public class SwapModsPatch : ModulePatch
    {
        ...
        public static bool Prefix(ModdingItemSelector __instance, Item item, Slot slot, bool simulate, ref Error error, ref bool __result)
        {
            ...
            var operation = InteractionsHandlerClass.Swap(item, slot.ContainedItem.Parent, slot.ContainedItem, item.Parent, __instance.InventoryController, simulate);
            if (operation.Failed)
            {
                return true;
            }
    ...
    public class ModEquippedPatch : ModulePatch
    {
        ...
        public static void Postfix(ContextInteractionSwitcherClass __instance, EItemInfoButton button, ref IResult __result)
        {
            ...
            {
                Item modItem = (Item)AccessTools.Field(typeof(ItemContextInteractionsSwitcher), "_item").GetValue(__instance);
                ItemController modItemController = (ItemController)AccessTools.Field(typeof(ItemContextInteractionsSwitcher), "_itemController").GetValue(__instance);
                if (!CanModify(modItem, modItemController as InventoryController, out string error))
                {
    ...
    public class CanDetachPatch : ModulePatch
    {
        ...
        protected override MethodBase GetTargetMethod()
        {
            MethodInfo method = AccessTools.Method(typeof(InteractionsHandlerClass), nameof(InteractionsHandlerClass.MovePathCheck));
        ...
        [PatchPostfix]
        public static void Postfix(Item item, ItemAddress to, TraderControllerClass itemController, ref Option<UnsetError> __result)
        {
    ...
    public class LockedStatePatch : ModulePatch
    {
        ...
        [PatchPostfix]
        public static void Postfix(Slot slot, ref KeyValuePair<EModLockedState, ModSlotView.TooltipData> __result, TraderControllerClass ___traderControllerClass)
        {
    ...
    public class InAssemblePatch : ModulePatch
    {
        ...
        protected override MethodBase GetTargetMethod()
        {
            return AccessTools.Method(typeof(WeaponBuilder), nameof(WeaponBuilder.Assemble));
        }
    ...
    public class DisassembleAllPatch : ModulePatch
    {
        ...
        // 4.1.2: DisassembleOperationsList already collects the full operation list
        [PatchPrefix]
        public static bool Prefix(ItemUiContext __instance, ItemContext itemContext, bool simulate, ref List<ItemOperation> __result)
        {
            ...
            __result = __instance.DisassembleOperationsList(itemContext, simulate);
            return false;
        }
    }
