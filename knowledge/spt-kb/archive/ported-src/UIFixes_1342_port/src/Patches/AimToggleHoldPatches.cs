...
public static class AimToggleHoldPatches
{
    ...
    public class UpdateInputPatch : ModulePatch
    {
        ...
        public static void Prefix(KeyBindingClass __instance, ref List<IInputKey> inputKeys)
        {
            ...
            if (__instance.GameKey == EGameKey.ReleaseTactical && ToggleHold.IsEnabled(EGameKey.Tactical))
            {
                ...
                Singleton<SharedGameSettingsClass>.Instance.Game.Settings.TacticalInputMode.SetValue(EFT.Settings.Game.GameSettingsGroup.ETacticalInputMode.Press);
            }
        }
        ...
        public static void Postfix(KeyBindingClass __instance)
        {
            ...
            {
                __instance.ChangeState((KeyBindingClass.EKeyState)ToggleHoldState.Idle);
            }
        }
    }
    ...
    public class ForceTacticalModePatch : ModulePatch
    {
        protected override MethodBase GetTargetMethod()
        {
            return AccessTools.Property(typeof(FirearmInputHandler), nameof(FirearmInputHandler.IsPressTacticalInteraction)).SetMethod;
        }
    ...
    public class ToggleInteractionPatch : ModulePatch
    {
        ...
        {
            if (command == ECommand.BeginInteracting && ___gamePlayerOwner_0 != null && ___gamePlayerOwner_0.Player.CurrentManagedState is PlantPlayerState)
            {
