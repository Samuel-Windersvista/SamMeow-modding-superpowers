...
public static class TagPatches
{
    public static void Enable()
    {
        ...
        // 4.1.2: KeepTagsLocalPatch removed (item serializer reworked)
    }
    ...
    public class OnEnterPatch : ModulePatch
    {
        ...
        {
            ____tagInput.onSubmit.AddListener(value => __instance.Save());
    ...
    // 4.1.2: KeepTagsLocalPatch removed (EFTItemSerializerClass no longer exists;
    // item serialization was reworked in 4.1.2)
