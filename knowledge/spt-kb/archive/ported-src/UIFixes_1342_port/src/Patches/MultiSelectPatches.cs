...
public static class MultiSelectPatches
{
    ...
    public static void Enable()
    {
        ...
        // 4.1.2: FindVerticalFirstPatch removed (Grid placement reworked)
        // 4.1.2: FindSpotKeepRotationPatch/FindPlaceToPutPatch removed (Grid placement reworked)
        ...
        public static bool Prefix(InventoryInteractions __instance, EItemInfoButton interaction)
        {
            ...
            switch (interaction)
            {
                case EItemInfoButton.Load:
                    MultiSelect.LoadAll(__instance.ItemUiContext, (CompoundItem[])AccessTools.Field(typeof(BaseInventoryItemContextInteractions), "_collections").GetValue(__instance), false);
                    return false;
    ...
    public class MoveOperationDontForgetAboutPinsPatch : ModulePatch
    {
        ...
        [PatchPostfix]
        public static void Postfix(OperationResult<MoveOperation> __result, bool simulate)
        {
    ...
    public class RememberPinOperationsPatch : ModulePatch
    {
        ...
        [PatchPostfix]
        public static void Postfix(OperationResult<PinOperation> __result, bool simulate)
        {
    ...
    // 4.1.2: FindPlaceToPutPatch + FindSpotKeepRotationPatch removed (Grid placement algorithm was reworked; Grid.FindLocationForItem is now the single placement path)
