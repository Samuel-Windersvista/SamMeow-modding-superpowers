...
public static class QueueInputPatches
{
    ...
    public class ReloadPatch : ModulePatch
    {
        ...
        public static void Postfix(FirearmHandsInputTranslator __instance, Player ___Player_0)
        {
            ...
            var firearmController = ((IFirearmHandsController)AccessTools.Field(typeof(FirearmHandsInputTranslator), "_controller").GetValue(inputTranslator)) as Player.FirearmController;
            ...
            if (firearmController == null || !firearmController.CanStartReload())
            {
                ...
                repeater.BeginTrying(EGameKey.ReloadWeapon, () =>
                {
                    if (firearmController == null)
                    {
                        ...
                        firearmController = ((IFirearmHandsController)AccessTools.Field(typeof(FirearmHandsInputTranslator), "_controller").GetValue(inputTranslator)) as Player.FirearmController;
                        if (firearmController == null)
                        {
                    ...
                    return firearmController.CurrentOperation is FirearmReloadingState;
                });
            }
            else
            {
