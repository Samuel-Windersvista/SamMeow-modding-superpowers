...
public static class InspectWindowStatsPatches
{
    ...
    public class CalculateModStatsPatch : ModulePatch
    {
            ...
            SimpleTooltip ___simpleTooltip_0)
        {
            ...
            var newCompactPanels = R.ItemSpecificationPanel.CreateCompactCharacteristicPanels(
                ...
                ____compactPanel,
                (attribute, viewer) => viewer.Show(attribute, ___simpleTooltip_0, false, 100));

            instance.CompactCharacteristicPanels = newCompactPanels;

            if (newCompactPanels.Any())
            {
                newCompactPanels.Last().Value.OnTextWidthCalculated += (_, _) => __instance.RecreateAttributeBars();
    ...
    public class CompareModStatsPatch : ModulePatch
    {
        protected override MethodBase GetTargetMethod()
        {
            return AccessTools.Method(typeof(ItemSpecificationPanel), nameof(ItemSpecificationPanel.Refresh));
        }
    ...
    public class AddShowHideModStatsButtonPatch : ModulePatch
    {
        ...
        [PatchPostfix]
        public static void Postfix(ItemSpecificationPanel __instance, ContextInteractions<EItemInfoButton> contextInteractions, Item ___item_0, InteractionButtonsContainer ____interactionButtonsContainer)
        {
            ...
            void CreateButton()
            {
                Sprite sprite = Resources.Load<Sprite>("Characteristics/Icons/Modding");
                ...
                ____interactionButtonsContainer.BindButton(toggleButton); // add to disposable list
            }
