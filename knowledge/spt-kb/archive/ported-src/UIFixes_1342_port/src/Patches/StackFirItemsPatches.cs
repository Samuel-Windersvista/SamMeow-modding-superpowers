...
public static class StackFirItemsPatches
{
    ...
    public class ContainerStackPatch : ModulePatch
    {
        ...
        {
            return AccessTools.Method(typeof(InteractionsHandlerClass), nameof(InteractionsHandlerClass.TryFindMergeableItem));
        }

        [PatchPrefix]
        public static bool Prefix(IEnumerable<EFT.InventoryLogic.IContainer> containersToPut, Item itemToMerge, ref StackableItem mergeableItem, int overrideCount, ref bool __result)
        {
