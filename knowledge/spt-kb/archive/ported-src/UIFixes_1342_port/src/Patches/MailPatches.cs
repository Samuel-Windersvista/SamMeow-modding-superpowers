...
public static class MailPatches
{
    ...
    public class MenuAttachmentsAreNewPatch : ModulePatch
    {
        protected override MethodBase GetTargetMethod()
        {
            return AccessTools.Method(typeof(MenuTaskBar), nameof(MenuTaskBar.SetNewMessagesCount));
        }
    ...
    public class DialogueViewAttachmentsAreNewPatch : ModulePatch
    {
        ...
        public static void Prefix(DialogueView __instance, ChatMessageClass message, bool ___bool_0, DialogueClass ___dialogueClass)
        {
            ...
            if (message.HasRewards)
            {
                __instance.NewMessagesCount = ___dialogueClass.New;
            }
        }
    }
    ...
    public class DialogueViewSelectedPatch : ModulePatch
    {
        ...
        protected override MethodBase GetTargetMethod()
        {
            SetInt32_1Method = AccessTools.Property(typeof(DialogueView), nameof(DialogueView.NewAttachmentsMessagesCount)).SetMethod;
            return AccessTools.Method(typeof(DialogueView), nameof(DialogueView.UpdateLastMessage));
        }
    ...
    public class InvokeAttachmentsChangedPatch : ModulePatch
    {
        protected override MethodBase GetTargetMethod()
        {
            return AccessTools.Method(typeof(DialogueClass), nameof(DialogueClass.UpdateDialogMessages));
        }
