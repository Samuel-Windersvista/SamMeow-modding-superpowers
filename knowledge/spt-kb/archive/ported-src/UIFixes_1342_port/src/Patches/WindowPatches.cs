    ...
    public class InventoryShowPatch : ModulePatch
    {
        protected override MethodBase GetTargetMethod()
        {
            return AccessTools.Method(
                ...
                [typeof(IHealthController), typeof(InventoryController), typeof(QuestController), typeof(AchievementsController), typeof(PrestigeController), typeof(CompoundItem), typeof(EInventoryTab), typeof(IEftSession), typeof(ItemContext), typeof(bool)]);
        }

        // The actual work of showing the inventory happens in Show; restore windows afterwards
        [PatchPostfix]
        public static void Postfix(ItemContext itemContext)
        {
