...
public static class TradingAutoSwitchPatches
{
    ...
    public class RefreshOnSwitchPatch : ModulePatch
    {
        ...
        [PatchPostfix]
        public static void Postfix(TraderDealScreen __instance, Trader ___traderClass_1)
        {
            ...
            _ = __instance.UpdateAssortment();
            // 4.1.2: PreparedItemsChanged/PreparedSumChanged events removed; refresh via UpdateAssortment()
        }
    }
    ...
    public class RestoreTabPatch : ModulePatch
    {
        ...
        [PatchPrefix]
        public static void Postfix(TraderScreensGroup __instance, ref TraderScreensGroup.ETraderMode ___traderMode)
        {
            if (LastTraderMode != TraderScreensGroup.ETraderMode.Trade)
            {
                ___traderMode = LastTraderMode;
                __instance.SetMode(___traderMode);
            }
        }
    }
    ...
    public class RememberTraderAndTabPatch : ModulePatch
    {
        ...
        [PatchPrefix]
        public static void Prefix(TraderScreensGroup __instance, TraderScreensGroup.ETraderMode ___traderMode)
        {
            LastTraderId = __instance.Trader.Id;
            LastTraderMode = ___traderMode;
        }
    }
}