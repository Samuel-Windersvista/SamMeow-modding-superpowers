...
public static class ReloadInPlacePatches
{
    ...
    public class ReloadInPlaceFindSpotPatch : ModulePatch
    {
        ...
        [PatchPrefix]
        public static void Prefix(StashGridClass grid, ref OperationResult<RemoveOperation> __state)
        {
        ...
        [PatchPostfix]
        public static void Postfix(OperationResult<RemoveOperation> __state)
        {
