...
public class FixPlayerInspectPatch : ModulePatch
{
    ...
    {
        return AccessTools.Method(typeof(PartyInfoPanel), nameof(PartyInfoPanel.Show));
    }
    ...
    public static bool Prefix(GroupPlayerViewModelClass raidPlayer)
    {
        ...
        return equipment.CurrentAddress?.Container?.ParentItem?.Owner is not Player.PlayerInventoryController;
    }
}