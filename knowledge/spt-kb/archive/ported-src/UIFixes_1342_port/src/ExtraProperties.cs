...
{
    private static readonly ConditionalWeakTable<Item, Properties> PropertiesTable = new();
...
{
    private static readonly ConditionalWeakTable<TemplatedGridsView, Properties> PropertiesTable = new();
...
{
    private static readonly ConditionalWeakTable<RagfairOfferItemView, Properties> PropertiesTable = new();
...
{
    private static readonly ConditionalWeakTable<ItemViewStats, Properties> PropertiesTable = new();
...
{
    private static readonly ConditionalWeakTable<IRaiseEvents, Properties> PropertiesTable = new();
