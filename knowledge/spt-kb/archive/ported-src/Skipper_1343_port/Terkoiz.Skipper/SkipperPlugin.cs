...
namespace Terkoiz.Skipper
{
    ...
    public class SkipperPlugin : BaseUnityPlugin
    {
        ...
        // PORT-NOTE: JetBrains.Annotations not present in the 4.1.2 reference set; [UsedImplicitly] is a
        // compile-time-only hint with no runtime effect, so it has been dropped.
        internal void Start()
        {
            Logger = base.Logger;
            InitConfiguration();
