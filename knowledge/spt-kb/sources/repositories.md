...
| wiki (SP-Tushonka fork, 本地) | `E:\云文件\GitHub\SP-Tushonka-wiki` | SP-Tushonka fork 的 wiki 源（现行 wiki.sp-tushonka.com 的渲染源）；锁定 commit `392e5005`（2026-09-11）；已 vendor 进 `../wiki-tushonka/`。克隆需走代理 `http://127.0.0.1:7890` |
